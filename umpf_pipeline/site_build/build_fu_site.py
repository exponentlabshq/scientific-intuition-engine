...
def build_home():
  ...
  <div class="page wide" style="padding-top:40px;">
    ...
    <h2 id="why-founded" style="margin-top:56px;">III. Why FU Was Founded</h2>
    <p style="color:var(--text-muted); max-width:680px;">FU exists to recover time &mdash; specifically, the years a real Masters or PhD student spends finding out, the slow and expensive way, that a hypothesis doesn&rsquo;t hold up. Running the collision is the easy part; a model proposes a plausible-sounding cross-domain hypothesis in seconds. The hard, slow, expensive part of science has never been having an idea. It has always been finding out, honestly, whether the idea was actually worth having.</p>
    <p style="color:var(--text-muted); max-width:680px;">That cost is not hypothetical. It is one of the best-documented, least-discussed facts about how research actually works:</p>

    <img src="fu-why-founded.jpg" alt="Infographic: Why FU Was Founded &mdash; the cost of research failure. 7.3 years average PhD completion time. 40-60% of PhD students never finish. 84% of surveyed biomedical PhD students failed to replicate their own results. $28.2B/yr estimated cost of irreproducible biomedical research. Science does not lack ideas. It lacks fast, honest ways to learn which ideas survive contact with reality." style="width:100%; max-width:900px; border-radius:14px; border:1px solid var(--border); display:block; margin:16px 0;">
